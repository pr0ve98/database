...
public class NetpayVO {
	...
	public String toString() {
		return "NetpayVO [idx=" + idx + ", sabun=" + sabun + ", buseo=" + buseo + ", name=" + name + ", jikkub="
				+ jikkub + ", age=" + age + ", ipsail=" + ipsail + ", gender=" + gender + ", address=" + address
				+ ", bonbong=" + bonbong + ", gongje=" + gongje + ", sudang=" + sudang + ", netpay=" + netpay + "]";
	}
